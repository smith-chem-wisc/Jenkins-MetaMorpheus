...
y4 = df["Crosslink Single Peptides"]
...
# set up legend
pyplot.legend((b1[0], b2[0], b3[0], b4[0]), ('Semi-Specific Search', 'Non-Specific Search', 'Modern Search', 'Crosslink Search'), loc=1, bbox_to_anchor=(1.1, 1.18))
