...
b4 = pyplot.bar(x, y5, width=width, bottom=y1+y2+y3+y4, color='yellow')

pyplot.legend((b1[0], b2[0], b3[0], b4[0]), ('Semi-Specific', 'Non-Specific', 'Cross Link', 'Modern', 'Glyco'), bbox_to_anchor=(1.1, 1.18), loc=1)
