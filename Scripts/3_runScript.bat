...
D:\Jenkins_Runs\MetaMorpheus_MasterBranch\MetaMorpheus\CMD\bin\Release\net6.0\cmd.exe -t D:\Jenkins_Runs\TestFiles\DataAndRunSettings\XL\Task1-XLSearchTaskconfig.toml -s D:\Jenkins_Runs\TestFiles\DataAndRunSettings\XL\2017-06-22_Lei_BSA_DSSO-Calibrated.mzml -d D:\Jenkins_Runs\TestFiles\DataAndRunSettings\XL\BSA.fasta -o D:\Jenkins_Runs\TestFiles\Results\XL_[%mydate%_%mytime%]
