...
REM This script exist for troubleshooting
REM Set the output directory to where you want it
set "JenkinsOutDir=D:\Jenkins_Runs\TestFiles\Results\DataAndRunSettings\MethylInGptmd
